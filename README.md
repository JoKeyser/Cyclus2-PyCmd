...
Idea: A command-line interface to interactively send commands to [Cyclus2 ergometers](https://www.cyclus2.com/en/).
...
1. TODO: Clone or download this project and run the code, once it exists :p.
